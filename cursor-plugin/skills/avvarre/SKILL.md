---
name: avvarre
description: Analyze code quality against Google style guides for 21 languages/formats.
  Use when reviewing files, running fix-verify loops, auditing a workspace, or managing project memory.
---
...
| 3rd | `medium` | Naming violations, missing braces, wrong casing |
